...
@Singleton
public class WalletsRepository implements IWalletsRepository {

    private final Random random = new SecureRandom();

    private final FirebaseFirestore firestore;

    private final ICoinsRepository coinsRepo;

    @Inject
    public WalletsRepository(ICoinsRepository coinsRepo) {
